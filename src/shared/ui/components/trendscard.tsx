...
const TrendCard: React.FC<TrendCardProps> = ({ name, rating, image }) => {
  return (
    <Link
      href='/pedidos'
      className='bg-bg2 hover:bg-bg3 border-bg3 relative flex min-h-[120px] w-[200px] min-w-[100px] flex-col items-center justify-center gap-2.5 rounded-xl border p-2 transition-shadow hover:shadow-lg'
    >
